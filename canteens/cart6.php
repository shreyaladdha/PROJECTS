...
session_start();
$db=mysqli_select_db($conn,"canteen6");
$slno=$_POST["items"];
$sum=0;
$row;
...
if(empty($slno))
{
    ...
    echo '<script>window.location.href = "menu6.php";</script>';
    return;  }
...
for($i=0;$i<$count;$i++)
{ 
    $sql_extract="SELECT item_name,price FROM canteen6 WHERE sl_no='$slno[$i]';";
