...
session_start();
$db=mysqli_select_db($conn,"canteen4");
$slno=$_POST["items"];
$sum=0;
$row;
...
if(empty($slno))
{
    ...
    echo '<script>window.location.href = "menu4.php";</script>';
    return;  }
...
for($i=0;$i<$count;$i++)
{ 
    $sql_extract="SELECT item_name,price FROM canteen4 WHERE sl_no='$slno[$i]';";
