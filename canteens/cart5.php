...
session_start();
$db=mysqli_select_db($conn,"canteen5");
$slno=$_POST["items"];
$sum=0;
$row;
...
if(empty($slno))
{
    ...
    echo '<script>window.location.href = "menu5.php";</script>';
    return;  }
 

//echo "TOTAL AMOUNT: <font> &nbsp; </font> $sum";
?>
...
for($i=0;$i<$count;$i++)
{ 
    $sql_extract="SELECT item_name,price FROM canteen5 WHERE sl_no='$slno[$i]';";
