...
<head>
    ...
    function fn3()
        {
            alert("Email Has Been Sent To The Regestered Email Id");
        }
        </script>
...
<body>
  ...
  <br>
      <a href="#" class="forgot-password" onclick="fn3()">Forgot your password?</a>
  ...
  <div class="overlay-container">
    <div class="overlay">
      ...
      <div class="overlay-panel overlay-right">
        <h1>New to this page?</h1><br>
        Kindly enter your personal details to <br>Sign-Up!
          <a href="Original_signup.php"><button id="signUp" >Sign Up</button></a><br><br>
          <h1>Are you an admin?</h1><br>
        Kindly use your account to sign-in!
          <a href="adminlogin.php"><button id="signUp" >Sign In</button></a>
      </div>
    </div>
  </div>
</div>
