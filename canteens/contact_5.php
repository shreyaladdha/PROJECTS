...
$sql_extract_contact = "SELECT * FROM contact_5;";
...
?>
        ...
        CANTEEN NAME:  <input style="border-radius: 20px;width:40%;margin-left:70px;  letter-spacing: 1px;text-align: center;" type = "text" value = "NANDINI SHOPPEE"><br>
